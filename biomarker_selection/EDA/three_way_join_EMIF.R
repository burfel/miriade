...
### read the 3 files
emif_protein_data <- read.table("/Users/felicia.burtscher/Documents/UL/DATASETS/EMIF-AD MBD Study/data_protein.tsv", sep = "\t", header = T)
emif_samples_data <- read.table("/Users/felicia.burtscher/Documents/UL/DATASETS/EMIF-AD MBD Study/samples.tsv", sep = "\t", header = T)
emif_clinical_data <- read.table("/Users/felicia.burtscher/Documents/UL/DATASETS/EMIF-AD MBD Study/Clinical_EMIFMBD_MIRIADE.csv", sep = ";", header = T)
