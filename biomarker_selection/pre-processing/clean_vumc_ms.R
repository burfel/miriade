...
ftd_mspec <- readxl::read_xlsx("/Users/felicia.burtscher/Documents/UL/DATASETS/VUMC/WBI_CSF_Candidates_FC1.5_P0.05_DP0.5_FTD_DLB.xlsx", sheet = 1) %>%
...
dlb_mspec <- readxl::read_xlsx("/Users/felicia.burtscher/Documents/UL/DATASETS/VUMC/WBI_CSF_Candidates_FC1.5_P0.05_DP0.5_FTD_DLB.xlsx", sheet = 2) %>%
  dplyr::rename(UniProt = Accession, Name = Gene, p.val = Pval) %>%
  dplyr::select(UniProt, Name, p.val)
...
write.table(vumc_mspec, file = "/Users/felicia.burtscher/Documents/UL/DATASETS/VUMC/cleaned_VUMC_mspec.tsv", sep = "\t", 
...
write.table(vumc_mspec_FTD, file = "/Users/felicia.burtscher/Documents/UL/DATASETS/VUMC/cleaned_VUMC_mspec_FTD.tsv", sep = "\t", 
            row.names = F, col.names = T, quote = F)
write.table(vumc_mspec_DLB, file = "/Users/felicia.burtscher/Documents/UL/DATASETS/VUMC/cleaned_VUMC_mspec_DLB.tsv", sep = "\t", 
            row.names = F, col.names = T, quote = F)
