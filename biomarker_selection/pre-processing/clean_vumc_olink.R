...
olp <- readxl::read_xlsx("/Users/felicia.burtscher/Documents/UL/DATASETS/Olink/20201216_OLINK_Data/Olink_proteins_list_Marek.xlsx") %>%
...
alzp <- read.csv("/Users/felicia.burtscher/Documents/UL/DATASETS/Olink/20201216_OLINK_Data/FVOL_AD_CON.csv", sep = ",", 
                 col.names = c("Name", "Effect", "p.val", "adj.p")) %>%
  dplyr::mutate(disease = "ALZ")
...
ftdp <- read.csv("/Users/felicia.burtscher/Documents/UL/DATASETS/Olink/20201216_OLINK_Data/FVOL_FTD_CON.csv", sep = ",",
                 col.names = c("Name", "Effect", "p.val", "adj.p")) %>%
  dplyr::mutate(disease = "FTD")
...
dlbp <- read.csv("/Users/felicia.burtscher/Documents/UL/DATASETS/Olink/20201216_OLINK_Data/FVOL_DLB_CON.csv", sep = ",",
                 col.names = c("Name", "Effect", "p.val", "adj.p")) %>%
  dplyr::mutate(disease = "DLB")
...
cutoffs <- readxl::read_xlsx("/Users/felicia.burtscher/Documents/UL/DATASETS/Olink/20201216_OLINK_Data/Perc_below_LOD_per_assay.xlsx")
...
write.table(all_up, file = "/Users/felicia.burtscher/Documents/UL/DATASETS/Olink/20201216_OLINK_Data/cleaned_VUMC_olink.tsv", sep = "\t", 
...
write.table(all_up_ALZ, file = "/Users/felicia.burtscher/Documents/UL/DATASETS/Olink/20201216_OLINK_Data/cleaned_VUMC_olink_AD.tsv", sep = "\t", 
            row.names = F, col.names = T, quote = F)
write.table(all_up_DLB, file = "/Users/felicia.burtscher/Documents/UL/DATASETS/Olink/20201216_OLINK_Data/cleaned_VUMC_olink_DLB.tsv", sep = "\t", 
            row.names = F, col.names = T, quote = F)
write.table(all_up_FTD, file = "/Users/felicia.burtscher/Documents/UL/DATASETS/Olink/20201216_OLINK_Data/cleaned_VUMC_olink_FTD.tsv", sep = "\t", 
            row.names = F, col.names = T, quote = F)
